...
Analyses were conducted in R version 4.3.3 (2024-02-29 ucrt) using RStudio 2024.4.0.735 and Quarto 1.6.42. A reproducibility package which includes data, code, and text is deposited in **github release url**. The release which corresponds to the version used to generate the article was also deposited at [10.5281/zenodo.19221824](https://doi.org/10.5281/zenodo.19221824). New versions of the article will be accompanied by new releases in Github and new versions of the deposit in Zenodo.

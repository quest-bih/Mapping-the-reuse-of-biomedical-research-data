...
Analyses were conducted in R version 4.3.3 (2024-02-29 ucrt) using RStudio 2024.4.0.735 and Quarto 1.6.42. A reproducibility package which includes data, code, and text is deposited in github with url [https://github.com/quest-bih/Mapping-the-reuse-of-biomedical-research-data](https://github.com/quest-bih/Mapping-the-reuse-of-biomedical-research-data), release v1.0.1. This release has been deposited in Zenodo under the concept DOI [https://doi.org/10.5281/zenodo.19235630](https://doi.org/10.5281/zenodo.19235630) [@cohenMatchingDataReferences2026], and the DOI has been added to the README file in Github. New versions of the article will be accompanied by new releases in Github and new versions of the deposit in Zenodo.

...
## Detecting datasets published by our institution {#sec-methods-charite}
...
To better understand the patterns of institutional dataset reuse, we analyzed in which repositories the reused datasets were deposited. We observed that out of `r res$all_matched_ids_count_dist` datasets which had been referenced, `r res$all_matched_ids_count_dist_geo` (`r round(res$all_matched_ids_count_dist_geo / res$all_matched_ids_count_dist * 100, 1)`%) had been deposited in the Gene Expression Omnibus (GEO) (@fig-repo-dist-ds). The overall pattern was very similar when looking at the level of references rather than datasets (@suppfig-repo-dist). Overall, references were overwhelmingly to datasets from the fields of genomics and proteomics, i.e., sequences of DNA, RNA, and proteins. On the level of individual references, the ten most-referenced repositories contain datasets which are predominantly constituted by sequence data. Only `r res$all_mentions_gen_and_discp_non_omcis` of `r format(res$all_mentions, scientific = FALSE, big.mark = ",")` data references (`r round(res$all_mentions_gen_and_discp_non_omcis / res$all_mentions * 100, 1)`%) referred to datasets of other type, deposited in either disciplinary repositories (e.g. Electron Microscopy Data Bank, `r res$all_mentions_emdb` references) or general-purpose repositories (e.g. Mendeley, `r res$all_mentions_mendeley` references). This clearly shows that 'omics' fields currently contribute the large majority of data references, and thus at least a major fraction of data reuse cases overall.
...
::: {.content-visible when-format="pdf"}
![Flowchart detailing the detection of Charité datasets referenced in the literature, as listed in the DCC. The flowchart shows the process from obtaining open and restricted-access dataset identifiers using both ODDPub and DataStet sources, through identification of datasets included in the DCC, up to determining the overall number of instances of dataset reuse. Data identified using ODDPub include datasets added after using ODDPub-identified datasets as a seed.](plots_files/plots_png/flowchart_high_res/flowchart.pdf){#fig-dist-counts width="\\linewidth"}
:::
...
Analyses were conducted in R version 4.3.3 (2024-02-29 ucrt) using RStudio 2024.4.0.735 and Quarto 1.6.42. A reproducibility package which includes data, code, and text is deposited in github with url [https://github.com/quest-bih/Mapping-the-reuse-of-biomedical-research-data](https://github.com/quest-bih/Mapping-the-reuse-of-biomedical-research-data), release v1.0.3. This release has been deposited in Zenodo under the concept DOI [https://doi.org/10.5281/zenodo.19235630](https://doi.org/10.5281/zenodo.19235630) [@cohenMatchingDataReferences2026], and the DOI has been added to the README file in Github. New versions of the article will be accompanied by new releases in Github and new versions of the deposit in Zenodo.
...
* Author Contributions:
  * Avihay Cohen [https://orcid.org/0000-0002-0829-0810](https://orcid.org/0000-0002-0829-0810): Data curation, Formal analysis, Investigation, Software, Validation, Visualization, and Writing - original draft. 
  * Blanka Ivanović [https://orcid.org/0000-0003-4915-6818](https://orcid.org/0000-0003-4915-6818): Data curation, Investigation, Validation, and Writing - original draft.
  * Anastasiia Iarkaeva [https://orcid.org/0000-0002-7370-1663](https://orcid.org/0000-0002-7370-1663): Validation and Writing - review & editing.
  * Vladislav Nachev [https://orcid.org/0000-0003-0521-6153](https://orcid.org/0000-0003-0521-6153): Methodology, Software, and Writing - review & editing.
  * Evgeny Bobrov [https://orcid.org/0000-0002-2368-464X](https://orcid.org/0000-0002-2368-464X): Conceptualization, Methodology, Project administration, Supervision, Validation, Writing - original draft, and Writing - review & editing.

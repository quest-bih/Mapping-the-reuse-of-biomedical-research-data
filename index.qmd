...
A reproducibility package which includes data, code, and text is deposited in **Github - put URL of public release**. The release which corresponds to the version used to generate the article was also deposited at http://doi.org/10.5281/zenodo.19221824. New versions of the article will be accompanied by new releases in Github and new versions of the deposit in Zenodo.

...
#   select(data_id_merged, Category, license, data_access, covid_related, repository) |>
#   distinct()
# 
# # Create links
# 
# links_ac_lic <- dcc_charite_for_sankey |>
#   mutate(source = case_when(Category == "acc_nr" ~ "Accession Number",
#                             .default = "DOI"),
#          target = license) |>
#   count(source, target) |>
#   rename(value = n) |>

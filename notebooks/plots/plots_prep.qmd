...
load(here("data", "wrangling_steps", "dcc_charite", "dcc_charite_joined_7_ds_years.RData"))

dcc_charite_joined_final <- dcc_charite_joined_7_ds_years
rm(dcc_charite_joined_7_ds_years)

...
load(here("data", "wrangling_steps", "dcc_charite", "dcc_charite_joined_8_ds_added_years.RData"))

dcc_charite_joined_final <- dcc_charite_joined_8_ds_added_years
rm(dcc_charite_joined_8_ds_added_years)
```

...
load(here("data", "wrangling_steps", "all_sources_binded",                                                      
          "dcc_detected_ids_all_sources_7_rep_fix.RData"))

# create a table with no overlapping sources
dcc_charite_joined_final_no_source_overlap <- dcc_detected_ids_all_sources_7_rep_fix |> 
  dplyr::filter(
...
dcc_charite_joined_final_dup_sources <- dcc_detected_ids_all_sources_7_rep_fix


rm(dcc_detected_ids_all_sources_7_rep_fix)
```
...
rep_dt_ds <- dcc_charite_joined_final_no_source_overlap |> 
   mutate(repository = case_when(
     repository %in% c("ncbi dbgap",
                             "ncbi dbgap (database of genotypes and phenotypesgenotypes and phenotypes)") ~ "NCBI dbGaP",
           repository == "figshare" ~ "Figshare",

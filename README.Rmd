...
## Project Title
_Investigating the Reuse of Biomedical Data Using the DCC_
...
library(here)
library(fs)
fs::dir_tree(path = here(), recurse = TRUE, max_depth = 3, type = "directory")

---

## Installation and Setup: Clone the repository to your local machine.
...
will create an "index.html" file with the rendered paper.
